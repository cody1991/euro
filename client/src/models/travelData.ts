...
export const attractionsData: Attraction[] = [
  // 阿姆斯特丹
  { id: 1, name: "梵高博物馆", name_en: "Van Gogh Museum", description: "世界最大的梵高作品收藏", latitude: 52.3584, longitude: 4.8811, category: "博物馆", rating: 4.8, city_id: 1, booking_required: true, booking_advance: "提前1-2个月", booking_notes: "非常热门，强烈建议提前在官网购票" },
  { id: 2, name: "安妮之家", name_en: "Anne Frank House", description: "安妮·弗兰克故居博物馆", latitude: 52.3752, longitude: 4.8840, category: "历史", rating: 4.6, city_id: 1, booking_required: true, booking_advance: "提前1-2个月", booking_notes: "需要在官网提前预约时间段，现场几乎买不到票" },
  ...
  { id: 4, name: "国立博物馆", name_en: "Rijksmuseum", description: "荷兰国家博物馆", latitude: 52.3600, longitude: 4.8852, category: "博物馆", rating: 4.7, city_id: 1, booking_required: true, booking_advance: "提前2-4周", booking_notes: "旺季建议提前购票，可以免排队" },
  ...
  // 巴黎
  { id: 6, name: "埃菲尔铁塔", name_en: "Eiffel Tower", description: "巴黎地标建筑", latitude: 48.8584, longitude: 2.2945, category: "地标", rating: 4.9, city_id: 2, booking_required: true, booking_advance: "提前2-4周", booking_notes: "登顶需要提前购票，旺季建议至少提前1个月" },
  { id: 7, name: "卢浮宫", name_en: "Louvre Museum", description: "世界最大艺术博物馆", latitude: 48.8606, longitude: 2.3376, category: "博物馆", rating: 4.8, city_id: 2, booking_required: true, booking_advance: "提前2-4周", booking_notes: "强烈建议提前购票，可以免排队快速入场" },
  ...
  { id: 10, name: "凡尔赛宫", name_en: "Palace of Versailles", description: "法国王宫", latitude: 48.8049, longitude: 2.1204, category: "历史", rating: 4.8, city_id: 2, booking_required: true, booking_advance: "提前2-4周", booking_notes: "强烈建议提前购票，旺季排队时间很长" },
  ...
  // 米兰
  { id: 24, name: "米兰大教堂", name_en: "Duomo di Milano", description: "哥特式建筑杰作", latitude: 45.4642, longitude: 9.1900, category: "宗教", rating: 4.7, city_id: 7, booking_required: true, booking_advance: "提前1-2周", booking_notes: "登顶需要提前购票，建议购买快速通道票" },
  { id: 25, name: "斯卡拉歌剧院", name_en: "Teatro alla Scala", description: "世界著名歌剧院", latitude: 45.4676, longitude: 9.1896, category: "文化", rating: 4.6, city_id: 7, booking_required: true, booking_advance: "提前1-2个月", booking_notes: "如需观看演出需提前购票，博物馆参观建议提前预约" },
  { id: 26, name: "最后的晚餐", name_en: "The Last Supper", description: "达芬奇壁画杰作", latitude: 45.4658, longitude: 9.1707, category: "艺术", rating: 4.8, city_id: 7, booking_required: true, booking_advance: "提前2-3个月", booking_notes: "⚠️ 最难预约的景点之一！每天限流严格，必须提前预约" },
  ...
  { id: 32, name: "圣马可大教堂", name_en: "St. Mark's Basilica", description: "拜占庭建筑杰作", latitude: 45.4345, longitude: 12.3398, category: "宗教", rating: 4.7, city_id: 8, booking_required: true, booking_advance: "提前1-2周", booking_notes: "旺季建议提前预约，可以免排队" },
  ...
  // 佛罗伦萨
  { id: 34, name: "圣母百花大教堂", name_en: "Cathedral of Santa Maria del Fiore", description: "文艺复兴建筑杰作", latitude: 43.7731, longitude: 11.2560, category: "宗教", rating: 4.8, city_id: 9, booking_required: true, booking_advance: "提前1-2周", booking_notes: "登穹顶需要提前预约，教堂免费但建议预约时间段" },
  { id: 35, name: "乌菲兹美术馆", name_en: "Uffizi Gallery", description: "文艺复兴艺术宝库", latitude: 43.7685, longitude: 11.2553, category: "博物馆", rating: 4.9, city_id: 9, booking_required: true, booking_advance: "提前2-4周", booking_notes: "强烈建议提前购票，现场排队时间很长" },
  ...
  { id: 37, name: "学院美术馆", name_en: "Accademia Gallery", description: "米开朗基罗大卫雕像", latitude: 43.7769, longitude: 11.2589, category: "博物馆", rating: 4.7, city_id: 9, booking_required: true, booking_advance: "提前2-4周", booking_notes: "大卫雕像非常热门，强烈建议提前购票" },
  ...
  // 罗马
  { id: 39, name: "斗兽场", name_en: "Colosseum", description: "古罗马竞技场", latitude: 41.8902, longitude: 12.4922, category: "历史", rating: 4.9, city_id: 10, booking_required: true, booking_advance: "提前1-2周", booking_notes: "建议购买含古罗马广场的联票，可免排队入场" },
  { id: 40, name: "古罗马广场", name_en: "Roman Forum", description: "古罗马政治中心", latitude: 41.8925, longitude: 12.4853, category: "历史", rating: 4.7, city_id: 10, booking_required: true, booking_advance: "提前1-2周", booking_notes: "建议购买与斗兽场的联票" },
  ...
  { id: 45, name: "圆形竞技场", name_en: "Verona Arena", description: "古罗马圆形剧场", latitude: 45.4391, longitude: 10.9944, category: "历史", rating: 4.6, city_id: 12, booking_required: true, booking_advance: "提前1-2周", booking_notes: "如有演出需提前购票，参观建议提前预约" },
  ...
  // 梵蒂冈
  { id: 50, name: "圣彼得大教堂", name_en: "St. Peter's Basilica", description: "世界最大的教堂", latitude: 41.9022, longitude: 12.4539, category: "宗教", rating: 4.9, city_id: 11, booking_required: true, booking_advance: "提前1-2周", booking_notes: "教堂免费但建议预约免排队，登穹顶需购票建议提前预约" },
  { id: 51, name: "西斯廷礼拜堂", name_en: "Sistine Chapel", description: "米开朗基罗壁画杰作", latitude: 41.9029, longitude: 12.4545, category: "艺术", rating: 4.8, city_id: 11, booking_required: true, booking_advance: "提前2-4周", booking_notes: "包含在梵蒂冈博物馆门票内，强烈建议提前购票" },
  { id: 52, name: "梵蒂冈博物馆", name_en: "Vatican Museums", description: "世界顶级艺术收藏", latitude: 41.9065, longitude: 12.4536, category: "博物馆", rating: 4.8, city_id: 11, booking_required: true, booking_advance: "提前2-4周", booking_notes: "非常热门，强烈建议提前购票，可免排队快速入场" },
  ...
  // 那不勒斯
  { id: 58, name: "庞贝古城", name_en: "Pompeii", description: "被维苏威火山掩埋的古罗马城市", latitude: 40.7510, longitude: 14.4989, category: "历史", rating: 4.9, city_id: 15, booking_required: true, booking_advance: "提前1周", booking_notes: "建议提前购票，旺季排队时间较长" },
